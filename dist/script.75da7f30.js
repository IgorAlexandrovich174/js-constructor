...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/image.png":[function(require,module,exports) {
...
var text = "<a href=\"https://github.com/IgorAlexandrovich174\" target=\"_blank\">\u0421\u0441\u044B\u043B\u043A\u0430 \u043D\u0430 \u0440\u0435\u043F\u043E\u0437\u0438\u0442\u043E\u0440\u0438\u0439</a> ";
var model = exports.model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  tag: 'h2',
  styles: {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'С соблюдением принципов SOLID и ООП в JavaScript', 'JavaScript- это просто, интересно.'], {
  styles: {
...
var Sidebar = exports.Sidebar = /*#__PURE__*/function () {
  function Sidebar(selector, updateSelector) {
...
},{"./site":"classes/site.js","../model":"model.js","./sidebar":"classes/sidebar.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "34781" + '/');
